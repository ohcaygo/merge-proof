...
async function run(config,{clientFactory}={}){
 ...
 for(const fixture of config.fixtures){
  assert(/^ohcaygo\/merge-proof-l3-lab-[a-z0-9-]+$/.test(fixture.repository)&&Number.isSafeInteger(fixture.repositoryId)&&Number.isSafeInteger(fixture.pr)&&['VERIFIED','NOT_PROVEN','FAIL'].includes(fixture.expected),'OWNED_SYNTHETIC_FIXTURE_REQUIRED');
  try{
   ...
   await client.authorize(fixture.repository,fixture.repositoryId);
