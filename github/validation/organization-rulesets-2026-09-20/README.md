...
- Signed App-delivered organization receipts need an explicitly authorized installation in this organization. Neither existing development App may be expanded to this repository under current scope. The owner-token observations above are not a substitute. The [separate validation-App proposal](validation-app-proposal.json) preserves the standard Administration Read boundary; no App was registered.
