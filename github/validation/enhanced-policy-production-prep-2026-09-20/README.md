...
Current product candidate: **9a35a7a2a8491dbec6d05a567ef69ac69a94753f**. The [validation organization checkout record](validation-organization-checkout.json) records the owner-authorized name change to `ohcaygo-merge-proof-validation-lab` and the exact scheduled-lab repository restriction. The change does not inherit live signed queue acceptance. Organization creation and Team purchase are now verified; the [real organization acceptance](../organization-rulesets-2026-09-20/README.md) records actual billing, provider enforcement and remaining boundaries. Historical records below retain their original candidate and observations. The complete affected GitHub suite passed **367/367** on `9a35a7a`; the initial sandbox socket denial and clean rerun are retained in the checkout record.

Baseline product candidate for the retained acceptance below: **838ed8f422605bc814c0a7d9d0140dabbe78fedb**. Last accepted real signed queue candidate: **7953ecdbd849c8afe0379bfec1b4a61133292c62**. These identities are distinct. Later documentation commits do not replace the product candidate. Frozen proof/verifier digest remains `b770fe7f5dac86730095e768e4c3c4b4e1856eae909b3757acfc756069e47b76`.
...
- The Team organization now exists. Real inherited organization rules, required-CI failure, provider rejection, review/coverage policy currentness, required-workflow refusal, landed content and unsigned replay were exercised on `9a35a7a`; see [acceptance](../organization-rulesets-2026-09-20/README.md). Second-account positive approval remains pending in GitHub, and App-delivered organization receipts require a separately authorized installation. These are distinct from the now-closed basic Team-plan gate.
...
2. GitHub rejected the initial name; the owner-authorized replacement `ohcaygo-merge-proof-validation-lab` now exists (ID `331842075`) on Team. Billing initially purchased three seats at $12/month. Ryan confirmed correction; authenticated licensing now shows two seats at $8/month effective October 20, 2026. The current period remains three seats/$12. `thatguyrw-boop` is still provider-reported pending despite the owner acceptance report. [Current readback and acceptance](../organization-rulesets-2026-09-20/README.md) supersede the historical checkout/prerequisite records.
...
Fresh follow-up against `9a35a7a`: [remaining authentication prerequisites](remaining-authentication-prerequisites.json) records provider-pending second-account membership, no companion key yet on its authenticated General page, and no noninteractive local administrator access for a separate-UID broker. The approved AWS preparation host is the next isolated runtime; do not substitute a shared-UID process. Primary browser-based temporary-session authentication is opened first; recovery follows after verified primary identity. Account IDs and cloud acceptance remain unknown until authentication. The [signed organization App Read-mode acceptance](../organization-rulesets-2026-09-20/README.md) is now recorded separately; it does not establish positive execution-policy or fresh queue acceptance.
