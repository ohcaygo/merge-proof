...
Ryan approved the architecture and $110/month ceiling in [approved preparation](LEVEL3-PREPARATION.md). AWS account access, GitHub Team Terms acceptance and the rejected non-production companion registration are the current inputs. Production deployment/cutover, production companion registration, public trust/checkpoint publication and irreversible production COMPLIANCE retention remain reserved. No AWS resource, Team organization/purchase, companion App or recurring job has been created by the preparation. The [costed recommendation](LEVEL3-RECOMMENDED-PRODUCTION.md) is retained as the basis of the approved choices.
