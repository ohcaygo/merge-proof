...
Prepared 2026-09-20. **Not deployed, not published, no resources purchased or scheduled.** Last live-validated product remains `7953ecdbd849c8afe0379bfec1b4a61133292c62`; policy code digest `b770fe7f5dac86730095e768e4c3c4b4e1856eae909b3757acfc756069e47b76`. The new locally tested companion-reader candidate is `5fd27e130a1bd098f89ba3f30d07bf27d1fd5b3b`; see its [separate boundary validation](../validation/enhanced-policy-boundary-2026-09-20/README.md). Documentation commits do not change either identity. The [accepted signed queue report](../validation/final-frontier-l3-2026-09-19/signed-queue-final.md) remains the live proof record for the earlier candidate.

The [least-privilege investigation and Enhanced Policy Proof design](../validation/final-frontier-l3-2026-09-19/least-privilege.md) fix the production default at Administration Read. Ryan approved the separate companion boundary in principle. The restricted reader/collector seam is now implemented and locally tested; customer enrollment/UI, process isolation, service routing/lifecycle and positive GitHub coverage aggregation remain unimplemented. The new candidate needs its own complete acceptance. `7953ecd` cannot be represented as shipping that mode; its positive signed lab run used an explicitly temporary injected Write credential.

Use the [concrete production recommendation and ordered owner checklist](LEVEL3-RECOMMENDED-PRODUCTION.md) for infrastructure decisions, including costs and exact scope. It supersedes the open-ended component selections below with one recommended configuration; those resources remain unapproved/uncreated.
...
| --- | --- | --- |
| Optional Enhanced Policy Proof installation | Boundary approved in principle. Approve concrete account/name and selected test repositories before registration, with separate production companion registration authorization. Primary App remains Read. No org Write is included. | Restricted component and tests exist; finish customer routing/opt-in, lifecycle and OS isolation, then validate the resulting candidate. The registered companion and shipped integration do not yet exist. |
...
Required pre-addendum §43 code accounting remains [22 items](../validation/final-frontier-l3-2026-09-19/charter-coverage.md). Positive coverage collection and complete Enhanced customer enrollment/UI, service lifecycle/currentness routing and OS credential isolation remain unimplemented; the narrow reader component alone does not close that item. New-org runner allowlisting and chosen-host backup/deployment configuration also remain implementation work. Optional log INFER, the alternative OIDC authentication branch and later Quint work remain explicitly absent as previously scoped. Production KMS/host/trust/backup/scheduler and external publication acceptance remain unexecuted owner/environment operations. **Level 3 is open.**
